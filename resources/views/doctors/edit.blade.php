...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Editar Doctor</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('doctors.update', $doctor->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="phone" class="form-control" name="phone" id="phone" value="{{ old('phone', $doctor->phone) }}">
                            @if ($errors->has('phone'))
                            <div class="text-danger">
                                {{ $errors->first('phone') }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="hospital_id" id="hospital">
                                ...
                                <option value="{{ $id }}" {{ ($doctor->hospital ? $doctor->hospital->id : old('hospital_id')) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                                @endforeach
                            </select>
